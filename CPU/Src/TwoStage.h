...
public:
    ...
    TwoStage(uint32_t _MEMORY, uint32_t _THRESHOLD, double _FILTER_RATIO = 0.7, double _SKETCH_RATIO = 0.3, double _ADMISSION_RATIO = 0.9, std::string _name = "Two-Stage"){
        this->name = _name;
