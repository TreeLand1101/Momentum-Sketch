...
## 實驗結果
Momentum-Sketch 在低記憶體預算下表現出卓越的準確性。在 16 KB 記憶體下，其平均 F1 分數比其他方法高出約 10% 至 520%，平均召回率高出約 13% 至 600%。特別的是，由於其計數器衰減策略 (counter decay strategy) 可消除過度估計 (overestimation)，Momentum-Sketch 在採用閾值式報告時，無論記憶體限制為何，皆可達到精確率 (precision) 1.0。Momentum-Sketch 利用 SIMD 加速大幅提升插入和查詢速度，在所有資料集上平均插入吞吐量提升 47.3%，查詢吞吐量提升 62.7%。
